...
<img src="https://latex.codecogs.com/svg.image?Tn&space;=&space;(&space;\overline{Xn}&space;-&space;\mu0&space;)/\sqrt{\widehat{Sn}}" title="Tn = ( \overline{Xn} - \mu0 )/\sqrt{\widehat{Sn}}" />
